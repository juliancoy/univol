...
function SunMeshOrb() {
  return (
    <div className="relative h-[78vw] w-[78vw] max-h-[420px] max-w-[420px] sm:h-[520px] sm:w-[520px]">
      ...
      <div className="absolute inset-0 flex items-center justify-center scale-[0.68] sm:scale-100">
        <HexPrismWordmark />
      </div>
    </div>
  );
...
export default function UniVolLandingPage() {
  return (
    <div className="h-[calc(100vh-92px)] overflow-x-hidden overflow-y-auto bg-white text-slate-900 selection:bg-orange-200 selection:text-[#0f172a]">
      <div className="relative h-full overflow-x-hidden">
        ...
        <main className="relative z-10 mx-auto grid h-full w-full max-w-7xl items-center gap-12 px-4 py-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:px-10">
          <div className="flex flex-col justify-center">
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.9, delay: 0.08 }}
              className="w-full max-w-2xl rounded-[2rem] border border-slate-200/70 bg-white/90 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)] sm:p-6"
            >
            ...
            >
              <div className="group/recipe relative w-full">
                <span
                  aria-hidden="true"
                ...
                <a
                  href="/recipe"
                  className="group relative z-10 flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-orange-500 bg-white px-6 py-5 text-3xl font-semibold leading-tight text-orange-600 shadow-[0_22px_60px_rgba(255,132,63,0.22)] transition hover:-translate-y-0.5 hover:bg-orange-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-orange-300 focus-visible:ring-offset-2 sm:px-8 sm:py-6 sm:text-4xl"
                >
                  The Recipe
                  <ChevronRight className="h-7 w-7 transition group-hover:translate-x-0.5 sm:h-8 sm:w-8" />
                </a>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative flex min-h-[360px] items-center justify-center sm:min-h-[520px]"
            >
              <SunMeshOrb />
            </motion.div>
        </main>
